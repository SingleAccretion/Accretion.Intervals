...
namespace Accretion.Intervals.Tests
{
    ...
    {
        public static IEnumerable<object[]> IntervalsOfDoubles { get; } = MakeContinuousIntervalsData.OfDouble(new List<(string, bool)>
        {
            ("[0,0]", false), 
            ("[0,5]", false),
        ...
        public static IEnumerable<object[]> IntervalsOfChar { get; } = MakeContinuousIntervalsData.OfChar(new List<(string, bool)>
        {
            ("['d','i']", false),
            ("['d','d']", false),
            ("('c','d']", false),
        ...
        public static IEnumerable<object[]> IntervalsOfDays { get; } = MakeContinuousIntervalsData.OfDay(new List<(string, bool)>
        {
            ($"[{Monday},{Friday}]", false),
        ...
        public static IEnumerable<object[]> IntervalsOfCoordinates { get; } = MakeContinuousIntervalsData.OfCoordinate(new List<(string, bool)>
        {
            ("[0,5]", false),
            ("[0,0]", false),
            ("(-1,0]", false),
