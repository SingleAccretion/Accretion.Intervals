...
namespace Accretion.Intervals.Tests
{
    public class ContinuousIntervalLengthTests
    {
        ...
        public static IEnumerable<object[]> IntervalsOfInt32 { get; } = MakeContinuousIntervalsData.OfInt(new List<(string, long)>()
        {
            (Empty, 0),
            ("[-1,1]", 2),
            ("[-1,1)", 2),
        ...
        public static IEnumerable<object[]> IntervalsOfDouble { get; } = MakeContinuousIntervalsData.OfDouble(new List<(string, double)>()
        {
            (Empty, 0),
            ("[-1,1]", 2),
            ("[-1,1)", 2),
        ...
        public static IEnumerable<object[]> IntervalsOfDayWithTimeSpanLength { get; } = MakeContinuousIntervalsData.OfDay(new List<(string, TimeSpan)>()
        {
            (Empty, TimeSpan.Zero),
        ...
        public static IEnumerable<object[]> IntervalsOfDayWithPeriodLength { get; } = MakeContinuousIntervalsData.OfDay(new List<(string, Period)>()
        {
        ...
        public static IEnumerable<object[]> IntervalsOfCoordinateWithLongLength { get; } = MakeContinuousIntervalsData.OfCoordinate(new List<(string, long)>()
        {
            (Empty, 0),
            ("[-1,1]", 2),
            ("[-1,1)", 1),
        ...
        public static IEnumerable<object[]> IntervalsOfCoordinateWithDistanceLength { get; } = MakeContinuousIntervalsData.OfCoordinate(new List<(string, Distance)>()
        {
            (Empty, Distance.Zero),
