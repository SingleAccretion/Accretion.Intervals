...
namespace Accretion.Intervals.Tests
{
    ...
    {
        public static IEnumerable<object[]> IntervalsOfDouble { get; } = MakeContinuousIntervalsData.OfDouble(new List<(string, double, bool)>()
        {
            (Empty, -1, false),
            (Empty, 0, false),
            (Empty, 1, false),
        ...
        public static IEnumerable<object[]> IntervalsOfChar { get; } = MakeContinuousIntervalsData.OfChar(new List<(string, char, bool)>()
        {
        ...
        public static IEnumerable<object[]> IntervalsOfDay { get; } = MakeContinuousIntervalsData.OfDay(new List<(string, Day, bool)>()
        {
        ...
        public static IEnumerable<object[]> IntervalsOfCoordinate { get; } = MakeContinuousIntervalsData.OfCoordinate(new List<(string, Coordinate, bool)>()
        {
            (Empty, null, false),
