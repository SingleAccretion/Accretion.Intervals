...
namespace Accretion.Intervals
{
    internal static class Throw
    {
        ...
        public static void OverloadResolutionFailed(Type type) => throw new InvalidOperationException($"There are too many suitable parser methods on {type.Name}. Overload resolution failed");
    }
}
