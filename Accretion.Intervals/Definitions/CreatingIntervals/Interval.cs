...
namespace Accretion.Intervals
{
    public static class Interval
    {
        ...
        public static Interval<T, TComparer> CreateClosed<T, TComparer>(T lowerBoundaryValue, T upperBoundaryValue) where TComparer : struct, IComparer<T> =>
        ...
        public static Interval<T, TComparer> CreateOpen<T, TComparer>(T lowerBoundaryValue, T upperBoundaryValue) where TComparer : struct, IComparer<T> =>
